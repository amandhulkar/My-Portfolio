...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10 text-center">
        <motion.div
        ...
        >
          ...
          {/* Short Introduction */}
          <p className="max-w-2xl mx-auto text-sm sm:text-lg text-gray-400 font-inter leading-relaxed px-4">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 px-8">
            <a
              href="#projects"
